...
<template>
  <div>
    ...
    <div class="min-h-screen bg-slate-100 dark:bg-slate-800">
      <nav class="bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-800">
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              ...
              <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                <JetNavLink :href="route('uploads.index')" :active="route().current('uploads.index')">
                  Uploads
                </JetNavLink>
              </div>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
              ...
              <div class="ml-3 relative">
                <JetDropdown align="right" width="48">
                  ...
                  <template #content>
                    <!-- Account Management -->
                    <div class="block px-4 py-2 text-xs text-slate-400 dark:text-slate-400">
                      Manage Account
                    </div>
            ...
            <div class="-mr-2 flex items-center sm:hidden">
              <button
                  class="inline-flex items-center justify-center p-2 rounded-md text-slate-400 dark:text-slate-500 hover:text-slate-500 dark:text-slate-500 dark:hover:text-slate-400 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:bg-gray-100 dark:focus:bg-slate-800 focus:text-slate-500 dark:focus:text-slate-400 transition"
        ...
        <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
          <div class="pt-2 pb-3 space-y-1">
            <JetResponsiveNavLink :href="route('uploads.index')" :active="route().current('uploads.index')">
              Uploads
